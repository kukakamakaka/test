    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver'     => 'mysql',
            'engine'     => 'InnoDB',
            'host'       => '127.0.0.1', // Вместо localhost лучше использовать IP
            'port'       => 3306,
            'database'   => 'octo_db',    // Имя базы, которую ты создала я TablePlus
            'username'   => 'root',       // Пользователь по умолчанию
            'password'   => '',           // Пароль в DBngin пустой по умолчанию
            'charset'    => 'utf8mb4',
